...
nav_dropdown_item = """                <div class="nav-dropdown">
...
def process_file(filepath):
    ...
    # Match 账号合租指南</a> and insert nav_dropdown_item after it
    if '账号合租指南' in content:
        # Find position of 账号合租指南</a>
        idx = content.find('账号合租指南</a>')
        if idx != -1:
            end_tag = '账号合租指南</a>'
            content = content[:idx + len(end_tag)] + '\n' + nav_dropdown_item + content[idx + len(end_tag):]
