...
$t_share    = $utf8.GetString([byte[]](0xe8, 0xb4, 0xa6, 0xe5, 0x8f, 0xb7, 0xe5, 0x90, 0x88, 0xe7, 0xa7, 0x9f, 0xe6, 0x8c, 0x87, 0xe5, 0x8d, 0x97)) # 账号合租指南
$t_links    = $utf8.GetString([byte[]](0xe5, 0x8f, 0x8b, 0xe6, 0x83, 0x85, 0xe9, 0x93, 0xbe, 0xe6, 0x8e, 0xa5)) # 友情链接
...
Write-Host "`n✅ Navbars updated with verified exact UTF-8 Chinese strings!"
