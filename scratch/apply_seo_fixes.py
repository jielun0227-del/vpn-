...
# Dictionary mapping relative HTML path to exact 150-160 char SEO description
updates = {
...
for rel_path, new_desc in updates.items():
    full_path = os.path.join(r"c:\Users\Lenovo\Desktop\椰汁博客", rel_path.replace("/", "\\"))
    ...
    # Verify character length of new_desc:
    l = len(new_desc)
    print(f"Updating {rel_path} -> Length: {l} chars")
